...
def dataset_level_completeness_check(dataset_df, required_fields, header_matching_methods):
    ...
    file = load_metadata_file(dataset_df)
...
def record_level_completeness_check(dataset_df, required_fields, available_headers=None, visualize=False):
    """
    ...
    if visualize:
        ...
        column_completeness.plot(kind='bar', stacked=True, figsize=(12,6), color=['#55CC99','#DD3333'],edgecolor='k')
        ...
        if available_headers is not None and len(available_headers)>0:
            plt.figure(figsize=(16,4))
            req_column_completeness.plot(kind='bar', stacked=True, figsize=(12,6), color=['#5577DD','#DD3333'],edgecolor='k')
            ...
            plt.figure(figsize=(16,4))
            req_column_completeness1.plot(kind='bar', stacked=True, figsize=(12,6), color=['#5577DD','#DD3333'],edgecolor='k')
